...
export class SubscriptionPlan extends AbstractEntity {
    ...
    @OneToMany(() => UserSubscription, (userSubscription) => userSubscription.subscriptionPlan, { cascade: true })
    userSubscriptions: UserSubscription[];

    @OneToMany(() => PlanFeature, (planFeature) => planFeature.subscriptionPlan, { cascade: true })
